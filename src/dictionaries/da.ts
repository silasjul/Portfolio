export const da = {
  ...
  services: {
    ...
    ai: {
      ...
      description:
        "Brug AI til at automatisere arbejdsgange, spare tid, forbedre brugeroplevelsen og få intelligent indsigt ud af dine data.",
  ...
  works: {
    ...
    title: "Det vi bygger",
    subtitle:
      "Fra komplekse AI-workflows til web-applikationer. Se hvad vi bygger.",
    aiApps: {
      title: "AI-drevne applikationer",
    ...
    customWeb: {
      ...
      description:
        "Dashboards, admin-paneler og SaaS-platforme, datalagring, visualisering og gennemtænkt UI/UX.",
  ...
  about: {
    ...
    value3Label: "Priser",
    value4: "Direkte",
    value4Label: "Kommunikation",
  },
  contact: {
    label: "Lad os tage en snak",
